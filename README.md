...
This section covers a complete and thorough walkthrough for installing an AU915 sketch onto and Arduino shield and operation of an attached eMging LoRa Shield. A *Windows 10 environment* is used for the walkthrough. However, the same process can easily be achieved on Linux, however, some of the instructions will vary.
...
**NOTE:** The version information is available on the bottom of the PCB board. A box on the PCB should be ticked to illustrate the specific model.
